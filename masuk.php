...
<head>
    ...
    <title>Barang Masuk - App Stok Barang</title>
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_POST['filter_tgl'])){
                                            ...
                                            if($mulai!=null || $selesai!=null){
                                                $ambilSemuaDataStok = mysqli_query($conn, "SELECT * FROM masuk m, stok s WHERE s.id_barang = m.id_barang AND tanggal BETWEEN '$mulai' AND DATE_ADD('$selesai',interval 1 day) ORDER BY id_masuk DESC");
                                            } else{
                                                $ambilSemuaDataStok = mysqli_query($conn, "SELECT * FROM masuk m, stok s WHERE s.id_barang = m.id_barang ORDER BY id_masuk DESC");
                                            }
                                        } else{
                                            $ambilSemuaDataStok = mysqli_query($conn, "SELECT * FROM masuk m, stok s WHERE s.id_barang = m.id_barang ORDER BY id_masuk DESC");
                                        }
